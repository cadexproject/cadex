...
/*
    ...
    one party without compromising the security of InstaKDX
...
/**
 * Manages InstaKDX. Processes lock requests, candidates, and votes.
 */
class CInstantSend
{
public:
...
/**
 * An InstaKDX transaction lock request.
 */
class CTxLockRequest
{
private:
...
/**
 * An InstaKDX transaction lock vote. Sent by a masternode in response to a
...
/**
 * An InstaKDX transaction lock candidate.
 */
class CTxLockCandidate
{
private:
