...
extern CInstaCADEX instantsend;

/*
    At 15 signatures, 1/2 of the masternode network can be owned by
    one party without compromising the security of InstaCADEX
...
extern bool fEnableInstaCADEX;

/**
 * Manages InstaCADEX. Processes lock requests, candidates, and votes.
 */
class CInstaCADEX
{
public:
...
public:
    ...
    bool IsLockedInstaCADEXTransaction(const uint256& txHash);
...
/**
 * An InstaCADEX transaction lock request.
 */
class CTxLockRequest
{
private:
...
/**
 * An InstaCADEX transaction lock vote. Sent by a masternode in response to a
...
/**
 * An InstaCADEX transaction lock candidate.
 */
class CTxLockCandidate
{
private:
