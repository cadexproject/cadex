...
struct Params {
    ...
    int nInstaCADEXConfirmationsRequired; // in blocks
    int nInstaCADEXKeepLock; // in blocks
    int nInstaCADEXSigsRequired;
    int nInstaCADEXSigsTotal;
    ...
    LLMQType llmqForInstaCADEX{LLMQ_NONE};
};
} // namespace Consensus
