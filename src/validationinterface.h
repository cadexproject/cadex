...
protected:
    ...
    virtual void NotifyInstaCADEXDoubleSpendAttempt(const CTransaction &currentTx, const CTransaction &previousTx) {}
...
struct CMainSignals {
    ...
    /** Notifies listeners of a attempted InstaCADEX double spend*/
    boost::signals2::signal<void(const CTransaction &currentTx, const CTransaction &previousTx)> NotifyInstaCADEXDoubleSpendAttempt;
