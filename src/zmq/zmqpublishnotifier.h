...
class CZMQPublishHashInstaCADEXDoubleSpendNotifier : public CZMQAbstractPublishNotifier
{
public:
    bool NotifyInstaCADEXDoubleSpendAttempt(const CTransaction &currentTx, const CTransaction &previousTx) override;
};
...
class CZMQPublishRawInstaCADEXDoubleSpendNotifier : public CZMQAbstractPublishNotifier
{
public:
    bool NotifyInstaCADEXDoubleSpendAttempt(const CTransaction &currentTx, const CTransaction &previousTx) override;
};
