...
bool CZMQPublishHashInstaCADEXDoubleSpendNotifier::NotifyInstaCADEXDoubleSpendAttempt(const CTransaction &currentTx, const CTransaction &previousTx)
{
...
bool CZMQPublishRawInstaCADEXDoubleSpendNotifier::NotifyInstaCADEXDoubleSpendAttempt(const CTransaction &currentTx, const CTransaction &previousTx)
{
