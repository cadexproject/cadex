...
std::string EntryDescriptionString()
{
    return "    \"size\" : n,                 (numeric) transaction size in bytes\n"
           ...
           "       ... ],\n"
           "    \"instantsend\" : true|false, (boolean) True if this transaction was sent as an InstaCADEX one\n"
           "    \"instantlock\" : true|false  (boolean) True if this transaction was locked via InstaCADEX\n";
}
...
void entryToJSON(UniValue &info, const CTxMemPoolEntry &e)
{
    ...
    info.push_back(Pair("instantlock", instantsend.IsLockedInstaCADEXTransaction(tx.GetHash()) || llmq::quorumInstaCADEXManager->IsLocked(tx.GetHash())));
}
...
UniValue mempoolInfoToJSON()
{
    ...
    ret.push_back(Pair("instantsendlocks", (int64_t)llmq::quorumInstaCADEXManager->GetInstaCADEXLockCount()));
