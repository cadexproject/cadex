...
void RegisterValidationInterface(CValidationInterface* pwalletIn) {
    ...
    g_signals.NotifyInstaCADEXDoubleSpendAttempt.connect(boost::bind(&CValidationInterface::NotifyInstaCADEXDoubleSpendAttempt, pwalletIn, _1, _2));
...
void UnregisterValidationInterface(CValidationInterface* pwalletIn) {
    ...
    g_signals.NotifyInstaCADEXDoubleSpendAttempt.disconnect(boost::bind(&CValidationInterface::NotifyInstaCADEXDoubleSpendAttempt, pwalletIn, _1, _2));
...
void UnregisterAllValidationInterfaces() {
    ...
    g_signals.NotifyInstaCADEXDoubleSpendAttempt.disconnect_all_slots();
