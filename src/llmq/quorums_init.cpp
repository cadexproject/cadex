...
void InitLLMQSystem(CEvoDB& evoDb, CScheduler* scheduler, bool unitTests, bool fWipe)
{
    ...
    quorumInstaCADEXManager = new CInstaCADEXManager(*llmqDb);
}

void DestroyLLMQSystem()
{
    delete quorumInstaCADEXManager;
    quorumInstaCADEXManager = nullptr;
...
void StartLLMQSystem()
{
    ...
    if (quorumInstaCADEXManager) {
        quorumInstaCADEXManager->Start();
    }
}
...
void InterruptLLMQSystem()
{
    ...
    if (quorumInstaCADEXManager) {
        quorumInstaCADEXManager->InterruptWorkerThread();
    }
}
