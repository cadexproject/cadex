...
public:
    ...
    // This is the case for example when a signature appears as part of InstaCADEX or ChainLocks
    ...
    // mechanism prevents possible conflicts. As an example, ChainLocks prevent conflicts in confirmed TXs InstaCADEX votes
    void RemoveRecoveredSig(Consensus::LLMQType llmqType, const uint256& id);
