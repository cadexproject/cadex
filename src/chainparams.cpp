...
// Copyright (c) 2018-2019 The Cadex developers
...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward, bool fTestnet)
{
    const char* pszTimestamp = fTestnet ?
                               "Cadex coin is live 2" :
                                "Cadex coin is live 2";
    const CScript genesisOutputScript = fTestnet ?
                               CScript() << ParseHex("04e60ea9519f2be2ea861c158d46065969bea7482aec8868b252788bceaaed6ddd79f681ddba7739085620dd01647174ba701d33248bb8298395d2e0d491c06904") << OP_CHECKSIG :
                               CScript() << ParseHex("04e60ea9519f2be2ea861c158d46065969bea7482aec8868b252788bceaaed6ddd79f681ddba7739085620dd01647174ba701d33248bb8298395d2e0d491c06904") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nInstaCADEXConfirmationsRequired = 6;
        consensus.nInstaCADEXKeepLock = 24;
        consensus.nInstaCADEXSigsRequired = 6;
        consensus.nInstaCADEXSigsTotal = 10;
        ...
        consensus.DIP0001Height = 73589;
        consensus.DIP0003Height = 73589;
        ...
        consensus.nMinimumStakeValue = 50000 * COIN;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = 1544157821;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nStartTime = 1544157821;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nStartTime = 1544157821;
        ...
        genesis = CreateGenesisBlock(1544267173, 75570, 0x1e0ffff0, 1, 50 * COIN, false);
        ...
        // CADEX script addresses start with '5'
        ...
        consensus.llmqForInstaCADEX = Consensus::LLMQ_50_60;
        ...
        chainTxData = ChainTxData{
            1560357000, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        consensus.nInstaCADEXConfirmationsRequired = 2;
        consensus.nInstaCADEXKeepLock = 6;
        consensus.nInstaCADEXSigsRequired = 6;
        consensus.nInstaCADEXSigsTotal = 10;
        ...
        genesis = CreateGenesisBlock(1571083196, 48338, 0x1f00ffff, 1, 50 * COIN, true);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        chainTxData = ChainTxData{
            1571083196, // * UNIX timestamp of last known number of transactions
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1544267395, 816880, 0x207fffff, 1, 50 * COIN, false);
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    CRegTestParams() {
        ...
        consensus.nInstaCADEXConfirmationsRequired = 2;
        consensus.nInstaCADEXKeepLock = 6;
        consensus.nInstaCADEXSigsRequired = 3;
        consensus.nInstaCADEXSigsTotal = 5;
        ...
        genesis = CreateGenesisBlock(1544267761, 2, 0x207fffff, 1, 50 * COIN, false);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        consensus.llmqForInstaCADEX = Consensus::LLMQ_5_60;
    }
