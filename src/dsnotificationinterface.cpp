...
void CDSNotificationInterface::UpdatedBlockTip(const CBlockIndex *pindexNew, const CBlockIndex *pindexFork, bool fInitialDownload)
{
    ...
    llmq::quorumInstaCADEXManager->UpdatedBlockTip(pindexNew);
...
{
    llmq::quorumInstaCADEXManager->SyncTransaction(tx, pindex, posInBlock);
...
{
    llmq::quorumInstaCADEXManager->NotifyChainLock(pindex);
}
